package kr.ac.kopo.minn.chapter05test.controller;
...
public class Example01Controller {
    ...
    public String requestMethod(@RequestParam("id") String userId, @RequestParam("passwd") String uaserPw, Model model) {
        ...
        model.addAttribute("data2", "요청 파라미터에 전달된 id값:" + userId
                                                    + "<br>요청 파라미터에 전달된 pwd값: " + uaserPw );
        return "viewPage";
    }

    @GetMapping("/exam02")
    public String requestMethod2(@RequestParam(value = "id", defaultValue = "Anonymous") String userId, @RequestParam("passwd") String uaserPw, Model model) {
        model.addAttribute("data1", "@RequestParam 연습");
        model.addAttribute("data2", "요청 파라미터에 전달된 id값:" + userId
                + "<br>요청 파라미터에 전달된 pwd값: " + uaserPw );
        return "viewPage";
    ...
    public String requestMethod6(@PathVariable("id1") String userId1, @MatrixVariable(value = "passwd", pathVar="id1") String userPw1,
        ...
        model.addAttribute("data2", "PathVariable에 전달된 id1 값: " + userId1
                                                            + "MatrixVarialbe에 전달된 pwd1 값: " + userPw1 +
                                                            "<br>PathVariable에 전달된 id2 값: " + userId2
                                                            + "MatrixVarialbe에 전달된 pwd2 값: " + userPw2);
        return "viewPage";
    }
